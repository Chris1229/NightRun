...
/**
 * 作者：by chris
 * 日期：on 2017/8/16 - 下午2:25.
 * 邮箱：android_cjx@163.com
 */

public class ModifyTeamInfoActivity extends BaseActivity implements View.OnClickListener{
    ...
    private LinearLayout headLinear, teamNameLinear;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_team_info,true);
    ...
    private void initView(){
        ...
        headLinear = (LinearLayout) findViewById(R.id.layout_team_icon);
        teamNameLinear =(LinearLayout)findViewById(R.id.layout_team_nick_name);
    ...
    public void onClick(View v) {
        switch (v.getId()){
            case R.id.layout_team_icon:
                showPhotoPopWindow();
                break;

            case R.id.layout_team_nick_name:
    ...
    private void showPhotoPopWindow() {
        shareDialog = new CActionSheetDialog(ModifyTeamInfoActivity.this);
    ...
    private void showNoSdCardDialog() {
        AlertDialog.Builder builder = new AlertDialog.Builder(ModifyTeamInfoActivity.this);
    ...
    protected void doTakePhoto() {
        try {
            ...
            ToastUtils.show(ModifyTeamInfoActivity.this, "没有图库");
        }
    }
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (resultCode != Activity.RESULT_OK) {// result is not correct
            ...
            if (requestCode == CAMERA_WITH_DATA_TO_THUMB) {
                ...
                if (null == mCurrentPhotoFile) {
                    ToastUtils.show(ModifyTeamInfoActivity.this, "内存不足");
                    return;
                }
...
//        }
    ...
    private void reqModifyHeadImage(String imageUrl) {
        ...
        HttpRequestProxy.get().create(reqModify, new AbsHttpRequestProxy.RequestListener() {
            ...
            public void onFailed(VolleyError error) {
                ...
                ToastUtils.show(ModifyTeamInfoActivity.this, error.toString());
            }
    ...
    public void onEventMainThread(TeamName teamname) {
        teamNick =teamname.getName();
        tvTeamName.setText(teamNick);
    }
}
