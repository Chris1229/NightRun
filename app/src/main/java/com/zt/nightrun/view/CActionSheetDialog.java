...
import com.chris.common.utils.PxUtils;
...
public class CActionSheetDialog extends PopupWindow {
	 ...
	 * @return
	 */
	public CActionSheetDialog addSheetItem(String strItem, int color, Drawable pic, OnSheetItemClickListener listener) {
		if (sheetItemList == null) {
			sheetItemList = new ArrayList<SheetItem>();
		}
		sheetItemList.add(new SheetItem(strItem, color,pic, listener));
		return this;
	}
	public CActionSheetDialog addSheetItem(String strItem, int color,  OnSheetItemClickListener listener) {
		...
		sheetItemList.add(new SheetItem(strItem, color,null, listener));
		return this;
	}
	...
	public CActionSheetDialog addSheetItem(String strItem, int color) {
		return addSheetItem(strItem, color,null, null);
	}
	...
	private void setSheetItems() {
		...
		for (int i = 1; i <= size; i++) {
			...
			Drawable pic = sheetItem.pic;
			final OnSheetItemClickListener listener = (OnSheetItemClickListener) sheetItem.itemClickListener;
			LinearLayout item = new LinearLayout(context);
			item.setLayoutParams(getParams(LayoutParams.MATCH_PARENT, LayoutParams.WRAP_CONTENT));
...
//				textView.set
				...
				textView.setPadding(0, PxUtils.dipToPixel(context, 10), 0, PxUtils.dipToPixel(context, 10));
			}
			...
			textView.setLayoutParams(new LayoutParams(LayoutParams.WRAP_CONTENT, baseDp * DP));
...
//			int paddingLeft = textView.getLeft();
//			int paddingLeft = textView.getCompoundPaddingLeft();
//			int paddingLeft1 = textView.getMeasuredWidth();
//			int o = textView.getWidth();
//			int p= item.getWidth();
//			int q = item.getMeasuredWidth();
//			float r = textView.getX();
//			int s = textView.getLeft();
//			Log.i("1014",""+paddingLeft+":::"+paddingLeft1);
//			Log.i("1014",""+o+":::"+p+":::"+q+":::"+r+":::"+s);
...
//			Log.i("1014",""+o+":::"+p+":::"+q+":::"+r+":::"+s);
	...
	public void dismiss() {
		...
		String deviceMode = SDeviceUtil.getDeviceModel();
		if (TextUtils.isEmpty(deviceMode) || deviceMode.equals("U705T")) {
	...
	public class SheetItem {
		...
		int color;
		Drawable pic;
		public SheetItem(String name, int color, Drawable pic,OnSheetItemClickListener itemClickListener) {
			this.name = name;
			this.color = color;
			this.pic = pic;
