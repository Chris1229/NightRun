package com.zt.nightrun.service;
 ...
 * android:process=":pushservice", 具体参考 {@link GetuiSdkDemoActivity}
 * MayiPushManager.getInstance().initialize(this.getApplicationContext(), userPushService), 其中
