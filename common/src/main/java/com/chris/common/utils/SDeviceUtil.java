...
/**
 * Created with IntelliJ IDEA. User: zijiefeng Date: 13-5-28 Time: 下午3:54
 */
public class SDeviceUtil {
	...
	public static int getScreenWidth() {
		return getScreenWidth(KeelApplication.getApplicationConext());
	}
	...
	public static int getScreenHeight() {
		return getScreenHeight(KeelApplication.getApplicationConext());
	}
    ...
    public static float getDisplayDensity() {
    	return getDisplayDensity(KeelApplication.getApplicationConext());
    }
